...
const Listning_1 = require("./Listning");
...
__decorate([
    type_graphql_1.Field(),
    typeorm_1.ManyToOne(() => Listning_1.Listing, (listing) => listing.comments, {
        eager: true,
        onDelete: "CASCADE",
    }),
    __metadata("design:type", Listning_1.Listing)
], Comment.prototype, "listing", void 0);
__decorate([
    type_graphql_1.Field(),
    typeorm_1.Column(),
    __metadata("design:type", Number)
