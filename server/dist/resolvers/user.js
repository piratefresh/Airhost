...
let SearchUserResponse = class SearchUserResponse {
};
__decorate([
    type_graphql_1.Field(() => [FieldError], { nullable: true }),
    __metadata("design:type", Array)
], SearchUserResponse.prototype, "errors", void 0);
__decorate([
    type_graphql_1.Field(() => [User_1.User], { nullable: true }),
    __metadata("design:type", Array)
], SearchUserResponse.prototype, "users", void 0);
SearchUserResponse = __decorate([
    type_graphql_1.ObjectType()
], SearchUserResponse);
let UserResolver = class UserResolver {
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            sendEmail_1.sendEmail(email, emailBody, "Forgot Password");
            return true;
        });
    }
    me({ req }) {
    ...
    getUsers(searchTerm) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (searchTerm.length > 2) {
                users = yield typeorm_1.getRepository(User_1.User)
...
__decorate([
    type_graphql_1.Query(() => SearchUserResponse, { nullable: true }),
