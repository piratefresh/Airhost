...
let PostResolver = class PostResolver {
    ...
    author(post) {
        return User_1.User.findOne(post.authorId);
    }
    votePost(postId, value, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const isUpVote = value !== -1;
            const realValue = isUpVote ? 1 : -1;
            const { userId } = req.session;
            const voted = yield Vote_1.Vote.findOne({ where: { postId, userId } });
...
], PostResolver.prototype, "votePost", null);
__decorate([
...
__decorate([
    type_graphql_1.Mutation((_returns) => ImageSignature),
    type_graphql_1.UseMiddleware(isAuth_1.isAuth),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", ImageSignature)
], PostResolver.prototype, "createImageSignature", null);
